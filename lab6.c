...
// draw polyhedron from polyhedron class
 void drawPolyhedronO(Polyhedron p){
			int normalIdx = 0;
 ...
 void drawPolyhedronI(Polyhedron p){
		 int normalIdx = 0;
		 int len = p.totalNumFaceVertices;
		 size_t position = 0;
		 //loop through face array
...
void display() {
    ...
    glPopMatrix();
		...
		drawPolyhedronO(truncatedRhombicDodecahedron);//draw
		glPopMatrix();
		...
		drawPolyhedronO(socerBall);//draw
		glPopMatrix();
		...
		drawPolyhedronO(truncatedIcosahedron);//draw
		glPopMatrix();
		...
		drawPolyhedronO(stellatedOctahedron);//draw
		glPopMatrix();
...
void initGL() {
    ...
    glEnable(GL_NORMALIZE);
		...
		float col11[4] = { 0, 0, 0, 1};
		float col12[4] = { 0, 0, 0, 1 };
		float col13[4] = { 0, 0.05, 0, 0.01 };
		...
		float col21[4] = { 0.5, 0.5, 0, 1};
		float col22[4] = { 0.5, 0.5, 0, 1};
		float col23[4] = { 0, 0, 0, 1};
		float position2[3] = { 1, 1, 0 };
